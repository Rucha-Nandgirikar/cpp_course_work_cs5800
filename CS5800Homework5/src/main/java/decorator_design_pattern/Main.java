...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Customer customer3 = new Customer("Chris", 2,order3);
    ...
    public static void displayTotalOrderCostWithDiscount(Customer customer) {
        System.out.println("Customer "+customer.getCustomerName() + "'s Loyalty Status: "+ customer.getCustomerLoyaltyStatus() + " STAR");
        ...
        double discount = customer.getOrder().getDiscount(customer.customerLoyaltyStatus);
        List <FoodItems> foodItems = customer.getOrder().getCustomerFoodItems();
        System.out.println("Order along with add-ons is as follows:");
        int i = 1;
        ...
        System.out.println("Total Cost with Discount for a "+customer.getCustomerLoyaltyStatus()+
                " STAR ("+discount+" %) Customer Loyalty Status is "+"$" +cost);
        System.out.println("-------------------------------------------------------------------");
    }
